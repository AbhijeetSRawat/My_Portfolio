...
const About = () => {
  return (
    <div className='flex flex-col w-full items-center mt-5 mb-20'>
        ...
        <div className='flex flex-col items-center mt-5'>
          <div className=''>
              <div className='text-3xl lg:text-5xl lg:my-6 font-semibold'>PERSONAL INFO:</div>
              <div className='flex flex-col lg:flex-row gap-2 lg:gap-20 p-4 lg:p-0'>
                  <div className='flex flex-col lg:gap-4'>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>First Name : <div className='text-gray-400'>Abhijeet</div></div>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>Last Name : <div className='text-gray-400'>Rawat</div></div>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>Age : <div className='text-gray-400'>21</div></div>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>Freelance : <div className='text-green-400'>Available</div></div>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>Phone : <div className='text-gray-400'>+91 91491 87519</div></div>
                    
                  </div>
                  <div className='flex flex-col lg:gap-4'>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>LinkedIn : <Link to="https://www.linkedin.com/in/abhijeet-singh-rawat-8079011ab/" className='text-blue-400'>Click Here!</Link></div>
                    
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>Nationality : <div className='text-gray-400'>Indian</div></div>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>Address : <div className='text-gray-400'>Kotdwara, Uttarakhand</div></div>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>E-mail : <div className='text-gray-400'>rawatab2@gmail.com</div></div>
                    <div className='flex gap-2 text-lg lg:text-2xl lg:gap-4'>Languages : <div className='text-gray-400'>Hindi,English</div></div>
                  </div>
              </div>
        ...
        <div className='flex flex-col lg:flex-row lg:gap-10 p-5 mt-5 gap-3'>
          <div className='flex flex-col gap-3 lg:gap-10' >
            <div className=' border border-gray-500 h-[20vh] rounded-xl p-7  '>
              <div className='text-5xl font-semibold text-yellow-500 lg:mb-4'> 2+</div>
              <div className='text-xl font-medium'>- Years of experience with MERN Stack</div>
            </div>
            <div className=' border border-gray-500 h-[20vh] rounded-xl p-7  '>
              <div className='text-5xl font-semibold text-yellow-500 lg:mb-4'>350+</div>
        ...
        <div className='w-full flex justify-center text-4xl  mb-5 font-semibold my-6 lg:my-10'>My Skills:</div>
        ...
        <div className='flex w-full p-5 gap-4 lg:w-[50vw] lg:my-6'>
          <div className='flex relative flex-col'>
            ...
            <div className='w-[1px] absolute left-[4vh] h-[47vh] lg:h-[28vh]  bg-gray-400'>
            </div>
          </div>
          <div className='flex flex-col gap-5'>
              <div className='bg-gray-500 w-[30vw] lg:w-[10vw] h-[4vh] flex justify-center items-center rounded-full'>2021 - 2025</div>
        ...
        <div className='flex w-full p-5 gap-4 lg:w-[50vw] lg:my-6'>
          <div className='flex relative flex-col'>
            ...
            <div className='w-[1px] absolute left-[4vh] h-[43vh] lg:h-[28vh] bg-gray-400'>
            </div>
          </div>
          <div className='flex flex-col gap-5'>
              <div className='bg-gray-500 w-[30vw] lg:w-[10vw] h-[4vh] flex justify-center items-center rounded-full'>2020</div>
        ...
        <div className='flex w-full p-5 gap-4 lg:w-[50vw] lg:my-6'>
          <div className='flex relative flex-col'>
            ...
            <div className='w-[1px] absolute left-[4vh] h-[37vh] lg:h-[28vh] bg-gray-400'>
            </div>
          </div>
          <div className='flex flex-col gap-5'>
              <div className='bg-gray-500 w-[30vw] lg:w-[10vw] h-[4vh] flex justify-center items-center rounded-full'>2018</div>
