    ...
    <div >
        ...
        <div className='h-16 relative bg-black flex p-2 z-[2] justify-around text-white text-xl items-center lg:flex-col lg:w-20 lg:justify-center lg:gap-10 lg:h-[100vh] translate-x-[-100%] opacity-0 transition-all duration-500 ease-out animate-[slide-in_1.5s_forwards] '>
            ...
            <NavLink to="/about" className='relative text-xl font-semibold rounded-full h-11 w-11 flex justify-center group items-center bg-[#4e4e4e] hover:bg-yellow-500 lg:h-14 lg:w-14 transition-all duration-1000 ease-in-out'>
                ...
                <FaUser />
                <div className="absolute  left-0 top-0 w-[145px] rounded-full h-14 bg-yellow-500 opacity-0 invisible lg:group-hover:visible lg:group-hover:opacity-100 transition-all duration-1000 ease-in-out transform lg:group-hover:scale-100 lg:group-hover:translate-x-16 flex pl-[18px] gap-4 items-center">
                 ABOUT ME
                </div>
            ...
            <NavLink to="/projects" className='relative text-xl font-semibold rounded-full h-11 w-11 flex justify-center group items-center bg-[#4e4e4e] hover:bg-yellow-500 lg:h-14 lg:w-14 transition-all duration-1000 ease-in-out'>
                ...
                <FaBriefcase />
                <div className=" absolute  left-0 top-0 w-[170px] rounded-full h-14 bg-yellow-500 opacity-0 invisible lg:group-hover:visible lg:group-hover:opacity-100 transition-all duration-1000 ease-in-out transform lg:group-hover:scale-100 lg:group-hover:translate-x-16 flex pl-[18px] gap-4 items-center">
                 MY PROJECTS
                </div>
